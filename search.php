                ...
                <div class="search-results">
                    ...
                    <?php
                        if ( $the_query->have_posts() ) {
                            ...
                            <div class="search-results__item">
                                <a href="#" class="search-results__title">Расчет стоимости ИТ-сервисов</a>
                                <p>... ИТ сервисов, определенное на уровне правления или высшего руководства. Названия
                                    таких структур попадают в одну из следующих категорий: Разработка прикладных систем
                                    Эксплуатация Поддержка Безопасность Архитектурное
                                    планирование И так далее Эти структуры начинают ссылаться ...</p>
                                <p class="mb-2">Дата: 23.05.2019</p>
                                <p>Путь: <a href="#">Главная</a> / <a href="#">Новости</a>
                                </p>

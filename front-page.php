                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="intro-about__text">
                                ...
                                <p>Штат сотрудников насчитывает более 201 специалистов (менеджеры проектов, архитекторы решений, бизнес – аналитики, разработчики, UX/UI- дизайнеры и QA инженеров).</p>
